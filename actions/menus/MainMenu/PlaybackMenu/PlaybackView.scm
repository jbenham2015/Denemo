...
(if (not (d-GetViewVisibility "print"))
	(d-SetViewVisibility "print" #t))
(if (or (d-Directive-movementcontrol? "TransposeMovementPrint") (d-Directive-score? "TransposeOnPrint")(d-Directive-staff? "TransposeStaffPrint"))
	(d-WarningDialog (_ "This movement/staff is transposed on typesetting - you cannot use Play Along with it!
(This warning does not apply if it is a dummy C to C transposition)")))
